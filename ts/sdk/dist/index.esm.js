...
function useCoreListTradeInfoQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return useQuery(["coreListTradeInfo", client.contractAddress, JSON.stringify(args)], function () { return client.listTradeInfo({
...
function useCoreGetTradeInfoQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return useQuery(["coreGetTradeInfo", client.contractAddress, JSON.stringify(args)], function () { return client.getTradeInfo({
        denomIn: args.denomIn,
...
function useCoreGetRebalanceQuery(_a) {
    var client = _a.client, options = _a.options;
    return useQuery(["coreGetRebalance", client.contractAddress], function () { return client.getRebalance(); }, options);
}
...
function useCoreGetConfigQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return useQuery(["coreGetConfig", client.contractAddress, JSON.stringify(args)], function () { return client.getConfig({
        time: args.time
    }); }, options);
}
function useCoreGetTotalSupplyQuery(_a) {
    var client = _a.client, options = _a.options;
    return useQuery(["coreGetTotalSupply", client.contractAddress], function () { return client.getTotalSupply(); }, options);
}
...
function usePeripherySimulateBurnExactAmountInQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return useQuery(["peripherySimulateBurnExactAmountIn", client.contractAddress, JSON.stringify(args)], function () { return client.simulateBurnExactAmountIn({
...
function usePeripherySimulateMintExactAmountOutQuery(_a) {
    var client = _a.client, args = _a.args, options = _a.options;
    return useQuery(["peripherySimulateMintExactAmountOut", client.contractAddress, JSON.stringify(args)], function () { return client.simulateMintExactAmountOut({
        coreAddr: args.coreAddr,
